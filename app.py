...
def mask_detection():
    ...
    if choice == 'Live Image':
        st.markdown('<h2 align="center">Detection on Live Image</h2>',
                    unsafe_allow_html=True)
        st.markdown(
            '<h3 align="center">This feature will be available soon!</h3>', unsafe_allow_html=True)
